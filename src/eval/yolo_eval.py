...
RUNS = {
    "processed_100_conf01": {
        ...
        "model_path": "runs/train/train_yolo26p2_processed_100ep/weights/best.pt",
        "conf": 0.1,
        "imgsz": 640,
    },
    ...
    "processed_120_conf01": {
        "image_dir": "dataset/processed/test/images",
        "label_dir": "dataset/processed/test/labels",
        "model_path": "runs/train/train_yolo26p2_processed_120ep/weights/best.pt",
        "conf": 0.1,
        "imgsz": 960,
    },
    ...
    "raw_100_conf01": {
        ...
        "model_path": "runs/train/train_yolo26p2_raw_100ep/weights/best.pt",
        "conf": 0.1,
        "imgsz": 640,
    },
    "raw_100_conf005": {
    ...
    "raw_120_conf01": {
        "image_dir": "dataset/raw/val/images",
        "label_dir": "dataset/raw/val/labels",
        "model_path": "runs/train/train_yolo26p2_raw_120ep/weights/best.pt",
        "conf": 0.1,
        "imgsz": 960,
    },
    "raw_120_conf005": {
    ...
    "augmented_100_conf01": {
        "image_dir": "dataset/data_augmented/val/images",
        "label_dir": "dataset/data_augmented/val/labels",
        "model_path": "runs/train/train_yolo26p2_augmented_100ep/weights/best.pt",
        "conf": 0.1,
        "imgsz": 640,
    },
    "augmented_100_conf005": {
        "image_dir": "dataset/data_augmented/val/images",
        "label_dir": "dataset/data_augmented/val/labels",
        "model_path": "runs/train/train_yolo26p2_augmented_100ep/weights/best.pt",
        "conf": 0.05,
